...
const productImagesTemplate = images.map(imageInfo => createProductCardTemplate(imageInfo)).join('');

const imagesGalleryEl = document.querySelector('.gallery');

imagesGalleryEl.innerHTML = productImagesTemplate;
...
imagesGalleryEl.addEventListener('click', onProductCardClick);